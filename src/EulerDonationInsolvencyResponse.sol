...
interface IEulerDonationInsolvencyEnvironmentRegistryResponseView {
...
contract EulerDonationInsolvencyResponse {
    ...
    function handleIncident(TrapAlert calldata alert) external {
        ...
        IEulerDonationInsolvencyEnvironmentRegistryResponseView registry = IEulerDonationInsolvencyEnvironmentRegistryResponseView(REGISTRY);
